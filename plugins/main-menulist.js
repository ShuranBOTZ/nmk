...
title: `╔════❒𝙴𝚂𝙲𝙴𝙷❒════╗`,
rows: [
{title: `═❒𝚂𝙲𝚁𝙸𝙿𝚃❒═ ⟐`, rowId: ".sc", description: ╠⋗"Menampilkan Script Bot Ini"},
]}]
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: sgc,
    mediaType: 2, 
    description: sgc,
    title: "ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴍᴀᴋᴀɴ ʙʀᴇᴇ",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/de464d9c2877aa50b76cb.jpg')).buffer(),
    sourceUrl: sgc
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
...
let res = "𝚂𝚞𝚍𝚊𝚑 𝙼𝚊𝚞 𝙿𝚊𝚐𝚒 𝙺𝚘𝚔 𝙱𝚕𝚞𝚖 𝚃𝚒𝚍𝚞𝚛 𝚔𝚊𝚔?"
if (time >= 4) {
res = "𝚂𝚎𝚕𝚊𝚖𝚊𝚝 𝙿𝚊𝚐𝚒 𝙺𝚊𝚔 🌄"
}
if (time >= 10) {
res = "𝚂𝚎𝚕𝚊𝚖𝚊𝚝 𝚂𝚒𝚊𝚗𝚐 𝚔𝚊𝚔 ☀️"
}
if (time >= 15) {
res = "𝚂𝚎𝚕𝚊𝚖𝚊𝚝 𝚂𝚘𝚛𝚎 𝙺𝚊𝚔 🌇"
}
if (time >= 18) {
res = "𝚂𝚎𝚕𝚊𝚖𝚊𝚝 𝚖𝚊𝚕𝚊𝚖 𝚔𝚊𝚔 🌙"
}
return res
}

...
//==============> Menu nya
let intro = `нᴀʟʟo ${tag} ᴀᴘᴀ κᴀʙᴀʀ?\n\nsᴇʙᴇʟuмɴʏᴀ ᴘᴇʀκᴇɴᴀʟκᴀɴ sᴀʏᴀ sнuʀᴀɴʙoтz\nʙoт( ʙuιʟᴅ - oᴘᴇʀᴀтᴇ - тʀᴀɴғᴇʀ) ʏᴀɴԍ ᴅιנᴀʟᴀɴκᴀɴ ᴅι wнᴀтsᴀᴘᴘ ʏᴀɴԍ ᴅικнususκᴀɴ uɴтuκ мᴇʟᴀʟuκᴀɴ sᴇsuᴀтu , ᴘᴇɴcᴀʀιᴀɴ ᴅᴀтᴀ ᴅᴀтᴀ мᴇʟᴀʟuι wнᴀтsᴀᴘᴘ, ᴀᴅᴀɴʏᴀ ғɪᴛᴜʀ ᴅᴀʀɪ ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ ɪɴɪ ᴛᴇɴᴛᴜ ᴀᴋᴀɴ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴜɴᴛᴜᴋ ʙᴇʀsᴇɴᴀɴɢ sᴇɴᴀɴɢ, ᴅʟʟ_`
conn.send3ButtonDoc(m.chat, `\n\n     *『 s н u ʀ ᴀ ɴ ʙ o т z 』*\n\n`, intro + `\n\n𒈞sнuʀᴀɴʙoтz𒈞\n\n`, 'Aʟʟ Mᴇɴᴜ', '.? all', 'Lɪsᴛ Mᴇɴᴜ', '.tesm', '\nAku Sayang jamal', 'bilek', m, { contextInfo: { forwardingScore: fsizedoc, externalAdReply: { body: 'jangan mudah dipercaya omongan seseorang', containsAutoReply: true, mediaType: 1, mediaUrl: hwaifu.getRandom(),  renderLargerThumbnail: true, showAdAttribution: true, sourceId: 'Tes', sourceType: 'PDF', previewType: 'PDF', sourceUrl: sgc, thumbnail: fs.readFileSync('./thumbnail.jpg'), thumbnailUrl: sgc, title: '「 s н u ʀ ᴀ ɴ ʙ o т z 」'}}})
    } 
